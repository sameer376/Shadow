...
HELP_OWNER = (
    "🛠═══ 🏷 𝐎𝐖𝐍𝐄𝐑 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 🏷 ═══🛠\n\n"
    "╭────────────────────────────╮\n"
    "│  📁 /set <keyword> <link> ➜ 𝐒𝐞𝐭 𝐟𝐢𝐥𝐞           │\n"
    "│  🗑️ /removekeyword <keyword> ➜ 𝐑𝐞𝐦𝐨𝐯𝐞 𝐤𝐞𝐲𝐰𝐨𝐫𝐝        │\n"
    "│  📢 /broadcast <message> ➜ 𝐒𝐞𝐧𝐝 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭    │\n"
    "│  📄 /logs ➜ 𝐒𝐡𝐨𝐰 𝐥𝐨𝐠𝐬                  │\n"
...
async def allkeywords(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not FILE_KEYWORDS:
        ...
        return
    text = "📂 𝐊𝐞𝐲𝐰𝐨𝐫𝐝𝐬:\n"
    for i, k in enumerate(FILE_KEYWORDS.keys(), 1):
        text += f"{i}. {k}\n"
